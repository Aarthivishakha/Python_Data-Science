# Integrated tool triggers (Python 3.9 source)
...
under both Python 3.9 and the isolated Python 3.10+ analyzer environment.
...
Each directory contains a `trigger.yaml` declaring the Python 3.9 source
