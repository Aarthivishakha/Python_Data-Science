# Data Science / ML Project (Python 3.14)
...
report. The implementation is compatible with Python 3.14 and uses only the
...
- `pyproject.toml`: Python 3.14 package metadata, test, coverage, and Ruff configuration.
...
- `.github/workflows/ci.yml`: native Python 3.14 tests plus isolated tool analysis.
