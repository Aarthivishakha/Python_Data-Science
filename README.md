# Data Science / ML Project (Python 3.12)
...
report. The implementation is compatible with Python 3.12 and uses only the
...
3.10+; the application itself remains Python 3.12 compatible.
...
- `pyproject.toml`: Python 3.12 package metadata, test, coverage, and Ruff configuration.
...
- `.github/workflows/ci.yml`: native Python 3.12 tests plus isolated tool analysis.
