# Data Science / ML Project (Python 3.5)
...
report. The implementation is compatible with Python 3.5 and uses only the
...
- `setup.py`: Python 3.5-compatible packaging and console entry point.
