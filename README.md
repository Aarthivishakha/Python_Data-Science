# Data Science / ML Project (Python 2.7)
...
report. The implementation is compatible with Python 2.7 and uses only the
...
3.10+; the application itself remains Python 2.7 compatible.
...
- `setup.py`: Python 2.7-compatible packaging and console entry point.
