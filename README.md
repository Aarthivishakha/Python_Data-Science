# Data Science / ML Project (Python 3.6)
...
report. The implementation is compatible with Python 3.6 and uses only the
...
3.10+; the application itself remains Python 3.6 compatible.
...
- `setup.py`: Python 3.6-compatible packaging and console entry point.
