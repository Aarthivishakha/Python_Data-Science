# Data Science / ML Project (Python 3.9)
...
report. The implementation is compatible with Python 3.9 and uses only the
...
3.10+; the application itself remains Python 3.9 compatible.
...
- `pyproject.toml`: Python 3.9 package metadata, test, coverage, and Ruff configuration.
...
- `.github/workflows/ci.yml`: native Python 3.9 tests plus isolated tool analysis.
