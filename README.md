# Data Science / ML Project (Python 3.11)
...
report. The implementation is compatible with Python 3.11 and uses only the
...
3.10+; the application itself remains Python 3.11 compatible.
...
- `pyproject.toml`: Python 3.11 package metadata, test, coverage, and Ruff configuration.
...
- `.github/workflows/ci.yml`: native Python 3.11 tests plus isolated tool analysis.
